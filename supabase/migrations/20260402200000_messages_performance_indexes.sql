...
-- CONCURRENTLY cannot be used within transactions
...
CREATE INDEX IF NOT EXISTS idx_conversations_participant1_activity 
ON conversations(participant_1, last_message_at DESC NULLS LAST) 
WHERE participant_1 IS NOT NULL;

CREATE INDEX IF NOT EXISTS idx_conversations_participant2_activity 
...
CREATE INDEX IF NOT EXISTS idx_conversations_unread_counts 
