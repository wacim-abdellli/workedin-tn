-- Fix: hire_proposal_atomic was inserting $9 (text) into payment_status (payment_status_enum)
...
COMMENT ON FUNCTION public.hire_proposal_atomic IS 'Atomically accepts a proposal, creates a pending-payment contract. Fixed: payment_status cast text->payment_status_enum.';
