...
export type TableFixture = JsonRecord | JsonRecord[] | null;
export type TableFixtures = Record<string, TableFixture>;

export function buildProfile(overrides: Partial<JsonRecord>): JsonRecord {
  return {
...
export function buildFreelancerFixtures(): TableFixtures {
  return {
...
export function buildClientFixtures(): TableFixtures {
  return {
    profiles: buildProfile({
...
export async function createRoleStatePage(
  browser: Browser,
  options: { storageState?: string; fixtures?: TableFixtures },
) {
...
export async function gotoAndSettle(page: Page, routePath: string, readySelector: string) {
