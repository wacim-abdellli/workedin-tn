...
import {
    getMessagesCacheKey,
    resolveConversationScopes,
    isConversationVisibleInMode,
    resolveModeCacheKey,
    readSessionCache,
    writeSessionCache,
    getCounterpartyRoleFromConversation,
    resolveAccentClasses,
    MAX_CACHED_MESSAGES,
} from './messages/utils';
import {
    hydrateConversationRow,
    fetchConversationById,
    fetchConversationByContractId,
    fetchConversationByParticipants,
    createContractConversationFallback,
} from './messages/conversationResolvers';
import { useContractStatusHydration } from './messages/useContractStatusHydration';
import { useContractActions } from './messages/useContractActions';
...
function MessagesComponent() {
    ...
    } = useContractStatusHydration({ conversations, userId: user?.id });
    ...
    const accentClasses: AccentClasses = useMemo(() => resolveAccentClasses(isFreelancerWorkspace), [isFreelancerWorkspace]);
