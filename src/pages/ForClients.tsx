...
function ForClients() {
    ...
    return (
        <div className="min-h-screen bg-[#faf8ff] text-[#171420] dark:bg-[#0b0912] dark:text-white">
            ...
            {/* Hero */}
            <section className="relative overflow-hidden border-b border-white/40 bg-white dark:bg-gray-800 dark:bg-gray-900/80 py-20 text-[#171420] backdrop-blur-xl dark:border-white/5 dark:bg-[#0f0d16] dark:text-white">
                    ...
                    <div className="max-w-3xl">
                        ...
                        <div className="flex flex-wrap gap-4">
                            ...
                            <Link to="/how-it-works">
                                <Button variant="outline" size="lg" className="rounded-xl border border-gray-300 px-6 py-3 text-gray-700 dark:text-gray-300 dark:text-gray-200 transition-all duration-200 hover:bg-gray-50 dark:bg-gray-800 dark:border-white/20 dark:text-gray-200 dark:hover:bg-white dark:bg-gray-900/5">
            ...
            {/* Benefits Grid */}
            <section className="bg-gray-50 dark:bg-gray-900 dark:bg-gray-800 py-20 transition-colors duration-500 dark:bg-[#0b0912]">
                <div className="container-custom">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="rounded-[24px] border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800 dark:bg-gray-900 p-8 shadow-sm dark:border-white/5 dark:bg-[#1a1825]">
                ...
                <div className="container-custom">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {t.forClients.categories.items.map((cat, i) => (
                            <div key={i} className="cursor-pointer rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 dark:bg-gray-900 p-6 text-center transition-all hover:border-primary-300 hover:shadow-md dark:border-white/5 dark:bg-[#1a1825]">
                                <h3 className="font-bold text-gray-700 dark:text-gray-300 dark:text-gray-200 transition-colors dark:text-gray-200">{cat}</h3>
                            </div>
                        ))}
                    </div>
                </div>
            ...
            <section className="py-20 bg-gray-50 dark:bg-gray-900 dark:bg-dark-900 transition-colors duration-500">
                <div className="container-custom">
            ...
            <section className="bg-[#120f1c] py-20 text-center text-white">
                <div className="container-custom max-w-2xl">
                    ...
                    <Link to="/signup?type=client">
                        <Button size="lg" className="rounded-xl bg-white dark:bg-gray-800 dark:bg-gray-900 px-12 py-4 text-lg font-bold text-secondary-900 hover:bg-secondary-50">
