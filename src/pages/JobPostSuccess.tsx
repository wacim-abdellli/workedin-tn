                ...
                <section className="radius-shell overflow-hidden border border-emerald-200/40 bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.12),transparent_28%),linear-gradient(135deg,rgba(255,255,255,0.98),rgba(244,241,255,0.94))] p-6 shadow-[0_32px_90px_-48px_rgba(16,185,129,0.22)] dark:border-white/10 dark:border-gray-800 dark:bg-[radial-gradient(circle_at_top_left,rgba(16,185,129,0.18),transparent_28%),linear-gradient(145deg,rgba(18,16,28,0.98),rgba(11,10,18,0.98))] sm:p-8">
                    <div className="grid gap-6 xl:grid-cols-[minmax(0,1.08fr)_320px]">
                        <div className="space-y-5">
                            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-white dark:bg-gray-800/80 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-emerald-700 shadow-sm dark:border-white/10 dark:border-gray-800 dark:bg-white/5 dark:text-emerald-200">
                        ...
                        <div className="rounded-[1.75rem] border border-primary-100/70 bg-white dark:bg-gray-800/72 p-5 shadow-sm dark:border-white/10 dark:border-gray-800 dark:white/[0.04]">
                            ...
                            <div className="mt-5 space-y-3">
                                {nextSteps.map((step, index) => (
                                    <div key={step.title} className="rounded-2xl border border-primary-100/70 bg-primary-50/60 p-4 dark:border-white/10 dark:border-gray-800 dark:white/[0.04]">
                ...
                <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_320px]">
                    <section className="premium-panel radius-shell p-6 sm:p-8">
                        ...
                        <div className="mt-6 grid gap-4 md:grid-cols-3">
                            <div className="rounded-[1.5rem] border border-primary-100/70 bg-white dark:bg-gray-800/72 p-5 dark:border-white/10 dark:border-gray-800 dark:white/[0.04]">
