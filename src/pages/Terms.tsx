                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="card prose prose-lg max-w-none">
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">{tx('legalPages.terms.sections.intro.text')}</p>
                        </section>
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">{tx('legalPages.terms.sections.platformUse.intro')}</p>
                            <ul className="list-disc list-inside text-gray-700 space-y-2">
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">{tx('legalPages.terms.sections.contractsPayments.intro')}</p>
                            <ul className="list-disc list-inside text-gray-700 space-y-2">
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-4">{tx('legalPages.terms.sections.disputes.text')}</p>
                        </section>
