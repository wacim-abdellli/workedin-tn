                ...
                main={
                    <div className="space-y-8">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                            <div className="flex flex-col items-center rounded-[1.6rem] border border-brand-light/70 bg-brand-light/20 p-6 dark:border-[var(--color-border-subtle)]">
                                <div className="relative group">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => fileInputRef.current?.click()}
                                        className="absolute -bottom-1 -end-1 w-9 h-9 rounded-full bg-brand text-white flex items-center justify-center shadow-lg hover:bg-brand-hover hover:scale-110 transition-all border-2 border-[var(--color-bg-elevated)]"
                                    >
