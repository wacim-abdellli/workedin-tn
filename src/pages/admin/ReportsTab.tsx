...
import { Check, Flag, Loader2, RefreshCw, X } from 'lucide-react';
        ...
        <ErrorBoundary titleAr="فشل تحميل البلاغات" titleFr="Echec du chargement des signalements" titleEn="Failed to load Reports tab">
            <div className="space-y-6">
                ...
                {isLoading ? (
                    ...
                    <div className="card p-0 overflow-hidden border-white/40 dark:border-white/10 bg-white/75 dark:bg-slate-950/45">
