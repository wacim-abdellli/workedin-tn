    ...
    return (
        <div className="p-6 sm:p-8">
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 dark:text-white">{t.profile.workSamples}</h2>
            ...
            <div className="space-y-8">
                {/* Bio */}
                <div className="bg-gray-50 dark:bg-gray-900/50 dark:bg-dark-800/30 rounded-2xl p-5 border border-gray-100 dark:border-gray-800 dark:border-dark-700">
                ...
                <div className="bg-gradient-to-br from-primary-50/80 to-primary-100/50 dark:from-primary-900/20 dark:to-primary-900/10 rounded-2xl p-5 border border-primary-100 dark:border-primary-900/30">
                    ...
                    <div className="flex items-center gap-4">
                        {!isRecording && !voiceBlob && (
                            ...
                            >
                                <div className="w-3 h-3 rounded-full bg-white dark:bg-gray-800 animate-pulse" />
                        ...
                        {isRecording && (
                            ...
                            >
                                ...
                                <span className="bg-white dark:bg-gray-800/20 px-2 py-0.5 rounded-md text-sm">{Math.round(recordingTime)}s</span>
                            </button>
                        )}

                        {voiceBlob && (
                            <div className="flex items-center gap-3 w-full bg-white dark:bg-gray-800 dark:bg-dark-800 rounded-xl p-3 border border-gray-200 dark:border-gray-700 dark:border-dark-600">
                                <button
                                ...
                                <div className="flex-1">
                                    <div className="h-2 bg-gray-100 dark:bg-gray-800 dark:bg-dark-600 rounded-full overflow-hidden">
                ...
                <div>
                    ...
                    <label className="block mb-6 group">
                        <div className="border-2 border-dashed border-gray-300 dark:border-dark-600 rounded-2xl p-8 text-center cursor-pointer hover:border-primary-500 dark:hover:border-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/10 transition-all duration-300">
                            <div className="w-16 h-16 rounded-full bg-gray-100 dark:bg-gray-800 dark:bg-dark-700 flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
                    ...
                    {workSamples.length > 0 && (
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {workSamples.map((sample, index) => (
                                <div key={index} className="p-3 bg-white dark:bg-gray-800 dark:bg-dark-800 rounded-xl border border-gray-100 dark:border-gray-800 dark:border-dark-700 flex gap-3 animate-fade-in group hover:shadow-md transition-shadow">
                                    <div className="w-16 h-16 rounded-lg bg-gray-100 dark:bg-gray-800 dark:bg-dark-700 flex-shrink-0 overflow-hidden">
                                        {sample.preview ? (
                ...
                <div className="flex gap-4 pt-6 border-t border-gray-100 dark:border-gray-800 dark:border-dark-700">
                    <Button
                        variant="ghost"
                        size="lg"
                        onClick={onBack}
