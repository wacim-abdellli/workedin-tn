  ...
  return (
    <div className="relative">
      <main
        ...
        className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(124,58,237,0.12),_transparent_28%)] page-bg-base px-4 py-10"
      >
        <div className="mx-auto flex min-h-[70vh] max-w-xl items-center justify-center">
          <div className="w-full rounded-[2rem] border border-[var(--color-border-default)] surface-card p-8 text-center shadow-[0_28px_80px_-36px_rgba(2,6,23,0.95)] backdrop-blur-xl sm:p-10">
            ...
            <h1 id={headingId} className="mt-6 text-3xl font-semibold tracking-tight text-on-surface">
