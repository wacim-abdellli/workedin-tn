...
export default function JobWizardLayout({
    ...
    return (
        <div className="mx-auto max-w-6xl space-y-5 lg:space-y-6">
            <section className="radius-shell overflow-hidden border border-[color:var(--workspace-primary)]/16 bg-[radial-gradient(circle_at_top_left,rgba(139,92,246,0.16),transparent_28%),radial-gradient(circle_at_top_right,rgba(245,158,11,0.10),transparent_24%),linear-gradient(140deg,rgba(255,255,255,0.99),rgba(247,241,255,0.96))] p-6 shadow-[0_36px_90px_-52px_rgba(109,40,217,0.30)] dark:border-white/10 dark:bg-[radial-gradient(circle_at_top_left,rgba(167,139,250,0.16),transparent_28%),radial-gradient(circle_at_top_right,rgba(245,158,11,0.08),transparent_22%),linear-gradient(145deg,rgba(20,17,30,0.98),rgba(11,10,18,0.99))] sm:p-8 lg:p-9">
                <div className="grid gap-6 xl:grid-cols-[minmax(0,1.08fr)_320px]">
                    <div className="space-y-5">
                        <div className="inline-flex items-center gap-2 rounded-full border border-[color:var(--workspace-primary)]/18 bg-white/80 px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[color:var(--workspace-primary)] shadow-sm dark:border-white/10 dark:bg-white/5">
                    ...
                    <div className="rounded-[1.9rem] border border-[color:var(--workspace-primary)]/14 bg-white/78 p-5 shadow-[0_20px_40px_-32px_rgba(15,23,42,0.45)] dark:border-white/10 dark:bg-white/[0.04]">
                ...
                <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
                    {steps.map((step) => {
                        ...
                        return (
                            <div
                                key={step.id}
                                className={`rounded-[1.5rem] border p-4 transition-all duration-200 ${isCurrent
                                    ? 'border-[color:var(--workspace-primary)]/28 bg-[color:var(--workspace-primary)]/[0.08] shadow-[0_24px_48px_-34px_rgba(109,40,217,0.45)]'
                                    : isCompleted
                                        ...
                                        : 'border-gray-200/80 bg-white/80 dark:border-white/10 dark:bg-white/[0.03]'}`}
                            >
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="min-w-0">
                                        <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#8b8aa0]">
            ...
            <section className="premium-panel radius-shell overflow-hidden border border-white/60 p-6 shadow-[0_28px_70px_-52px_rgba(15,23,42,0.55)] dark:border-white/5 sm:p-8">
                {children}
            </section>
        </div>
    );
