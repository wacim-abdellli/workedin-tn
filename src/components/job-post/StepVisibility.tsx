...
export default function StepVisibility() {
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="flex gap-3 rounded-[1.6rem] border border-primary-100/80 bg-primary-50/70 p-5 shadow-sm dark:border-white/10 dark:bg-white dark:bg-gray-800/[0.04]">
