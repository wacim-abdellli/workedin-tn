            ...
            <section className="space-y-6 rounded-[1.8rem] border border-primary-100/70 bg-white dark:bg-gray-800/80 p-6 shadow-sm dark:border-white/10 dark:border-gray-800 dark:bg-white dark:bg-gray-800/[0.04]">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <select
                                {...register('category')}
                                className="w-full appearance-none rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 ps-11 pe-10 py-3 text-gray-900 dark:text-gray-100 dark:text-white transition-all duration-200 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-white/10 dark:border-gray-800 dark:bg-[#1a1825] dark:text-white"
                            >
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <select
                                ...
                                className="w-full appearance-none rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 ps-11 pe-10 py-3 text-gray-900 dark:text-gray-100 dark:text-white transition-all duration-200 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 disabled:cursor-not-allowed disabled:bg-gray-50 dark:bg-gray-900 disabled:text-gray-400 dark:border-white/10 dark:border-gray-800 dark:bg-[#1a1825] dark:text-white dark:disabled:bg-[#14121f]"
                            >
                ...
                <div className="space-y-2">
                    ...
                    <textarea
                        ...
                        rows={8}
                        className="w-full resize-none rounded-[1.4rem] border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-3 text-gray-900 dark:text-gray-100 dark:text-white placeholder:text-gray-400 transition-all duration-200 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-white/10 dark:border-gray-800 dark:bg-[#1a1825] dark:text-white dark:placeholder:text-gray-600 dark:text-gray-300"
                        ...
                        return (
                            <button
                                ...
                                className={`px-3 py-2 rounded-full text-sm font-medium border transition-colors ${isSelected
                                    ...
                                    : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:border-primary-200 hover:bg-primary-50/50 dark:border-white/10 dark:border-gray-800 dark:bg-[#1a1825] dark:text-gray-300 dark:hover:border-primary-500/20 dark:hover:bg-white dark:bg-gray-800/[0.06]'
                                    }`}
                            >
