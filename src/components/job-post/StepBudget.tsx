        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <label className={`
                    ...
                    ${jobType === 'fixed_price'
                        ...
                        : 'border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:border-primary-200 hover:bg-primary-50/40 dark:border-white/10 dark:border-gray-800 dark:bg-[#1a1825] dark:hover:border-primary-500/20 dark:hover:bg-white dark:bg-gray-800/[0.06]'
                    }
                `}>
                    <input
                        type="radio"
            ...
            <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                <div className="space-y-3 rounded-[1.6rem] border border-primary-100/70 bg-white dark:bg-gray-800/80 p-5 shadow-sm dark:border-white/10 dark:border-gray-800 dark:bg-white dark:bg-gray-800/[0.04]">
                    ...
                    <select
                        {...register('duration')}
                        className="w-full appearance-none rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-3 text-gray-900 dark:text-gray-100 dark:text-white transition-all duration-200 focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20 dark:border-white/10 dark:border-gray-800 dark:bg-[#1a1825] dark:text-white"
                    >
                ...
                <div className="space-y-3 rounded-[1.6rem] border border-primary-100/70 bg-white dark:bg-gray-800/80 p-5 shadow-sm dark:border-white/10 dark:border-gray-800 dark:bg-white dark:bg-gray-800/[0.04]">
                    ...
                    <div className="grid gap-2">
                        <label className="inline-flex items-center gap-2 rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-3 py-2.5 cursor-pointer dark:border-white/10 dark:border-gray-800 dark:bg-[#1a1825]">
