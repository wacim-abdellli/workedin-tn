            ...
            <div className="container-custom relative py-16 md:py-20">
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-[minmax(0,1.2fr)_220px_220px_minmax(0,1fr)]">
                    <div className="max-w-xl">
                        ...
                        <p className="mb-8 max-w-lg text-lg leading-relaxed text-[#a8a2bb]">
                            {t.footer.description}
                        </p>

                        <div className="mb-8 space-y-3.5">
                            <div className="flex items-center gap-3 text-[#b8b3ca]">
                                <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-white/8 bg-white dark:bg-gray-800 dark:bg-gray-900/[0.04]">
                        ...
                        <div className="flex items-center gap-3">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    className="flex h-11 w-11 items-center justify-center rounded-xl border border-white/8 bg-white dark:bg-gray-800 dark:bg-gray-900/[0.04] text-[#a8a2bb] transition-all duration-300 hover:-translate-y-0.5 hover:border-[color:var(--workspace-primary)]/20 hover:bg-[color:var(--workspace-primary)]/12 hover:text-white"
                                >
                        ...
                        <ul className="space-y-4">
                            {footerLinks.slice(0, 3).map((link) => (
                                <li key={link.href}>
                                    <Link
                                        to={link.href}
                                        className="group flex items-center gap-2 text-[#a8a2bb] transition-colors hover:text-white"
                                    >
                    ...
                    <div>
                        ...
                        <div className="rounded-[1.75rem] border border-white/8 bg-white dark:bg-gray-800 dark:bg-gray-900/[0.04] p-5 backdrop-blur-sm">
                            ...
                            <div className="flex flex-col gap-3 sm:flex-row">
                                <input
                                    ...
                                    className="min-w-0 flex-1 rounded-xl border border-white/10 dark:border-gray-800 bg-[#171422] px-4 py-3 text-white placeholder:text-[#7f7894] transition-colors focus:border-[color:var(--workspace-primary)] focus:outline-none"
                                />
                ...
                <div className="mt-16 border-t border-white/6 pt-8">
                    <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
                        <div className="flex items-center gap-1 text-sm text-[#a8a2bb]">
                            {t.footer.madeInTunisia}
                            <Heart className="h-4 w-4 fill-current text-accent-500" />
                        </div>
                        <div className="text-sm text-[#a8a2bb]">
                            {t.footer.copyright}
                        </div>
                    </div>
                </div>
