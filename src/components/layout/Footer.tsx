                        ...
                        <div className="rounded-[1.75rem] border border-white/8 bg-white/[0.04] p-5 backdrop-blur-sm">
                            ...
                            <div className="flex flex-col gap-3 sm:flex-row">
                                <input
                                    ...
                                    className="min-w-0 flex-1 rounded-xl border border-white/10 bg-[#171422] px-4 py-3 text-white placeholder:text-[#7f7894] transition-colors focus:border-[color:var(--workspace-primary)] focus:outline-none"
                                />
