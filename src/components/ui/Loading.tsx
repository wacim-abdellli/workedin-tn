    ...
    if (fullScreen) {
        return (
            <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden bg-[var(--page-bg)] transition-all duration-300">
                ...
                <div className="relative mx-6 flex w-full max-w-[320px] flex-col items-center rounded-[2rem] border border-[var(--color-border-subtle)] bg-[var(--color-bg-elevated)] px-8 py-10 text-center shadow-xl backdrop-blur-xl">
                    <div className="absolute inset-x-10 top-6 h-20 rounded-full bg-[color:var(--workspace-primary)]/10 blur-3xl" />

                    <div className="relative flex h-24 w-24 items-center justify-center rounded-[1.75rem] border border-[var(--color-border-subtle)] bg-[var(--color-bg-elevated)] shadow-md">
                    ...
                    <div className="relative mt-7 h-12 w-12">
                        <div className="absolute inset-0 rounded-full border-[3px] border-[var(--color-border-subtle)]" />
                        ...
                        <div className="absolute inset-[8px] rounded-full bg-[color:var(--workspace-primary)]/10" />
