...
export default function ContractDetailsSidebar({
    ...
    return (
        <div className="h-full flex flex-col bg-gray-50 dark:bg-gray-900 border-s border-gray-200 dark:border-gray-700 overflow-y-auto">

            {/* 1. Status Banner */}
            <div className={`p-4 border-b border-gray-100 dark:border-gray-800 ${currentStatus === 'active' ? 'bg-blue-50/50' :
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                <button
                    ...
                    className="w-full flex items-center justify-between p-4 hover:bg-gray-50 dark:bg-gray-900 transition-colors"
                ...
                {expandedSection === 'milestones' && (
                    <div id={milestonesPanelId} className="p-4 bg-gray-50 dark:bg-gray-900 space-y-3">
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                ...
                {expandedSection === 'files' && (
                    <div id={filesPanelId} className="p-4 bg-gray-50 dark:bg-gray-900 text-center text-sm text-gray-500 dark:text-gray-400">
            ...
            <div className="mt-auto p-4 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                ...
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center overflow-hidden">
