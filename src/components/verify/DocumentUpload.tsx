        ...
        <div className="rounded-3xl border border-white/10 dark:border-gray-800 bg-white dark:bg-gray-800/90 p-6 shadow-2xl shadow-slate-900/10 backdrop-blur-sm dark:border-white/10 dark:border-gray-800 dark:bg-[var(--color-bg-elevated)]/90 md:p-8">
            ...
            <div className="mb-8">
                {preview ? (
                    <div className="relative overflow-hidden rounded-2xl border-2 border-primary-500/70 group">
                        ...
                        <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                            <div className="flex items-center gap-3">
                                <button onClick={() => document.getElementById(inputId)?.click()} className="rounded-lg bg-white px-4 py-2 font-medium text-gray-900 dark:text-gray-100 transition-colors hover:bg-gray-100 dark:bg-gray-800 dark:text-white">
                                    {tx('verifyIdentity.changeImage', undefined, 'Change')}
                                </button>
                                <button onClick={onClear} className="inline-flex items-center gap-1 rounded-lg border border-white/40 bg-white dark:bg-gray-800/15 px-4 py-2 font-medium text-white transition-colors hover:bg-white dark:bg-gray-800/25">
                                    <X className="h-4 w-4" />
                    ...
                    >
                        <div className="w-16 h-16 bg-gray-100 dark:bg-gray-800 dark:bg-gray-700 rounded-full flex items-center justify-center text-gray-400 group-hover:text-primary-500 mb-4 transition-colors">
                ...
                {fileMeta && (
                    <div className="mt-3 inline-flex items-center gap-2 rounded-lg bg-gray-100 dark:bg-gray-800 px-3 py-1.5 text-xs text-gray-700 dark:text-gray-300 dark:bg-gray-700 dark:text-gray-200">
