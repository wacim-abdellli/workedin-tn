...
export default function VerificationStepper({ step, stepLabels, onStepClick }: VerificationStepperProps) {
    ...
    return (
        <div className="relative mb-10 flex items-center justify-between rounded-2xl border border-white/10 border-border bg-card/5 px-2 py-5 backdrop-blur-sm md:px-6 md:py-6">
            {/* Track background */}
            <div className="absolute left-5 right-5 top-1/2 h-1 -z-10 rounded-full bg-card/15" />
            {/* Progress fill */}
            <div
