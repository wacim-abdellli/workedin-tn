...
function ProposalCard({ proposal, onMessage, onShortlist, onHire }: ProposalCardProps) {
    ...
    return (
        <div className={`bg-white dark:bg-gray-800 rounded-2xl border transition-all duration-200 hover:shadow-md ${status === 'shortlisted' ? 'border-primary-200 ring-1 ring-primary-100' : 'border-gray-100 dark:border-gray-800'}`}>
            <div className="p-6">
                <div className="flex flex-col lg:flex-row gap-6">
                    ...
                    <div className="flex-1 min-w-0 border-t lg:border-t-0 lg:border-s border-gray-100 dark:border-gray-800 pt-4 lg:pt-0 lg:pe-6">
                        ...
                        <div className="relative">
                            <p className={`text-gray-600 dark:text-gray-300 leading-relaxed text-sm ${!expanded ? 'line-clamp-3' : ''}`}>
                                {cover_letter}
                            </p>
