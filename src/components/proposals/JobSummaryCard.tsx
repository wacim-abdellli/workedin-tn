        ...
        <div className="space-y-4">
            <div className="bg-white rounded-xl border border-gray-100 overflow-hidden">
                <div className="p-4 border-b border-gray-100 bg-gray-50">
                    <h3 className="font-bold text-gray-900">تفاصيل الوظيفة</h3>
                </div>
            ...
            <div className="bg-gradient-to-br from-primary-900 to-primary-800 rounded-xl p-5 text-white">
                ...
                <button className="w-full py-2 bg-white text-primary-900 rounded-lg font-bold text-sm hover:bg-primary-50 transition-colors">
                    عرض التوصيات
                </button>
            </div>
        </div>
