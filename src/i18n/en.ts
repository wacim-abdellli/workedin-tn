...
export const en: Translations = {
    ...
    authPages: {
        login: {
            badge: 'Trusted freelance marketplace',
            heroTitle: 'Sign in without the clutter and get back to work fast.',
            heroDescription: 'A calmer auth flow for clients and freelancers, with clearer states, trusted payments, and workspace switching that stays out of your way.',
            highlightTrustTitle: 'Verified identities',
            highlightTrustDescription: 'Profiles, contracts, and verification signals stay visible across your workspace.',
            highlightPaymentsTitle: 'Protected transactions',
            highlightPaymentsDescription: 'Escrow-first flows keep client payments and freelancer delivery aligned.',
            highlightLocaleTitle: 'Built for Tunisia',
            highlightLocaleDescription: 'Arabic, French, and English flows tuned for local freelance work.',
        ...
        signup: {
            ...
            heroTitle: 'Create a sharper first impression for every project you start.',
            heroDescription: 'Choose your role, set up your workspace, and move into onboarding with a cleaner, more focused auth experience.',
            highlightRoleTitle: 'Role-first onboarding',
            highlightRoleDescription: 'Start as client or freelancer and land in the right workspace from the first step.',
            highlightTrustTitle: 'Trust signals ready',
            highlightTrustDescription: 'Verification, identity checks, and profile structure are built into the journey.',
            highlightWorkTitle: 'Prepared for real work',
            highlightWorkDescription: 'Move from sign-up to posting jobs, building a profile, and closing contracts faster.',
