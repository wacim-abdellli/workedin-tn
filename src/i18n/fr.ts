...
export const fr: Translations = {
    ...
    howItWorks: {
        ...
        trust: {
            ...
            verified: { title: 'Chaque professionnel est vérifié', desc: "Nous vérifions l'identité nationale avant toute mise en ligne sur WorkedIn." },
        ...
        faq: {
            ...
            items: [
                ...
                { q: "Comment mon argent est-il protégé ?", a: "WorkedIn agit comme tiers de confiance. Les fonds restent sécurisés jusqu'à la validation du travail." },
