export const ar = {
    ...
    howItWorks: {
        ...
        clientSteps: [
            ...
            },
            {
                ...
                description: 'كل مستقل موثق الهوية. صفّ حسب التقييم، المهارة، والسعر.'
            },
            {
    ...
    forClients: {
        hero: {
            badge: 'وظّف محترفين تونسيين موثقين',
            title: 'مشروعك، منجَز.',
            titleHighlight: 'في الوقت. في الميزانية.',
            subtitle: 'انشر مجاناً. استقبل عروضاً من محترفين موثقين. ادفع فقط عند موافقتك — كل مدفوعة محمية بالضمان.',
            cta: 'انشر مشروعك — مجاناً',
            secondary: 'اكتشف كيف يعمل'
        },
        benefits: {
            speed: { title: 'توظيف في 24 ساعة', desc: 'انشر مشروعك واستقبل عروضاً موثقة في نفس اليوم.' },
    ...
    auth: {
        ...
        emailNotConfirmed: 'البريد الإلكتروني غير مفعّل',
        login: 'تسجيل الدخول',
        signup: 'إنشاء حساب',
        ...
        accountPanel: {
            ...
            switchWorkspaceBoth: 'تبديل بين مساحة المستقل والعميل',
            switchWorkspaceSingle: 'إدارة مساحة العمل الخاصة بك',
            ...
            freelancerDesc: 'العمل كمستقل وتقديم الخدمات',
            clientDesc: 'العمل كعميل لتوظيف المستقلين',
            current: 'الحالي',
            switchAction: 'التبديل للمساحة',
            enable: 'تفعيل المساحة',
            switching: 'جاري التبديل...',
            switchedFreelancer: 'تم التبديل لمساحة المستقل',
            switchedClient: 'تم التبديل لمساحة العميل',
            switchError: 'خطأ أثناء التبديل',
        },
    },
    jobs: {
    ...
    onboarding: {
        ...
        freelancer: {
            ...
            uploadAvatarDesc: 'يفضّل استخدام صورة مهنية واضحة',
        }
    },
